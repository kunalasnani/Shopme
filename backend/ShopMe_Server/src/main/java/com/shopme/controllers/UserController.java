...
public class UserController {
	...
	public @ResponseBody ResponseEntity<?> signUp(@RequestBody User newuser) throws CustomException {
		...
		if (user == null) {
			return Response.error("User with same mail id already exists, please try with another email.");
		} else
	...
	public @ResponseBody ResponseEntity<?> updateUser(@PathVariable int id, @RequestBody User UserDetails)
	...
	public @ResponseBody ResponseEntity<?> updateWallet(@PathVariable int id, @RequestBody User UserDetailsmoney)
			throws CustomException {
	...
	public @ResponseBody ResponseEntity<?> deductWallet(@PathVariable int id, @RequestBody User UserDetailsmoney)
			throws CustomException {
	...
	public @ResponseBody ResponseEntity<?> changepass(@PathVariable int id, @RequestBody User userpass)
			throws CustomException {
	...
	public @ResponseBody ResponseEntity<?> findproductaddedbyuserindb(@PathVariable("userid") int id)
			throws CustomException {
